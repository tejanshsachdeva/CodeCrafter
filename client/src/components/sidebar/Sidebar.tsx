...
function Sidebar() {
    ...
    }, [activityState, setActivityState, socket, isMobile, setIsSidebarOpen])

    const sidebarButtons = [
        { view: VIEWS.FILES, icon: viewIcons[VIEWS.FILES] },
        { view: VIEWS.CHATS, icon: viewIcons[VIEWS.CHATS] },
        { view: VIEWS.RUN, icon: viewIcons[VIEWS.RUN] },
        { view: VIEWS.CLIENTS, icon: viewIcons[VIEWS.CLIENTS] },
        { view: VIEWS.SETTINGS, icon: viewIcons[VIEWS.SETTINGS] },
    ]
    ...
    return (
        <aside className="flex w-full md:h-full md:max-h-full md:min-h-full md:w-auto">
            ...
            >
                {sidebarButtons.map(({ view, icon }) => (
                    <SidebarButton key={view} viewName={view} icon={icon} />
                ))}
