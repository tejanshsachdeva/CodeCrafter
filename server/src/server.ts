...
function getRoomId(socketId: SocketId): string | null {
    ...
    if (!roomId) {
        console.error("Room ID is undefined for socket ID:", socketId, "Current userSocketMap:", userSocketMap);
        return null;
    }
    return roomId;
}
...
function getUserBySocketId(socketId: SocketId): User | null {
    ...
    if (!user) {
        console.error("User not found for socket ID:", socketId, "Current userSocketMap:", userSocketMap);
        return null;
    }
    return user;
}
...
io.on("connection", (socket) => {
    ...
    socket.on("disconnecting", () => {
        ...
        if (user) {
            ...
            console.warn(`Socket ID ${socket.id} not found in userSocketMap`);
        }
    });
